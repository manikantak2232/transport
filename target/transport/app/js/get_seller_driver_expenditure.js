$(document).ready(function (){ 
				$('#get').click(function () {
					...
					$.ajax({
						url: '/transport/seller/expenditure/get',
						type: 'POST',
			            ...
			            success: function(response) {
			            	...
			            	for(var i=0; i<factoriesList.Factories.length; i++){
				            	...
				            	table_rows = table_rows + 
				            					"<tr width=100%>"+
					            					...
					            					"<td width=15% style='text-align:left; padding-left:3px; padding-right:3px; display:none'>" + factory.pk_seller_dispatch_id + "</td>"+		            						
				            						...
				            						"<td width=5% style='text-align:center; padding-left:3px; padding-right:3px'> <input type='button' id='but' onclick='fun("+factory.pk_seller_dispatch_id+")' value='get'></td>"+
				            					"</tr>";
			            	...
			            	var table_header = "<tr width=100%>"+
								            	...
								            	"<td width=15% style='background-color:#CCCCCC; padding-left:3px; padding-right:3px; display:none'>" +"Seller Dispatch Id" + "</td>"+
...
function fun(seller_dispatch_id){
	
	var fk_driver_id= $('#fk_driver_id').val();
	
	window.open("http://www.svtc.co/app/views/close_seller_driver_expenditure.html?"+
		"seller_dispatch_id="+seller_dispatch_id+"&fk_driver_id="+fk_driver_id);
