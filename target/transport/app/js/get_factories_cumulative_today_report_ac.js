            ...
            xhr.abort();    
					...
					xhr=$.ajax({	
			            ...
			            success: function(response) {
			            	...
			            	/*var svtcData1 = $.grep(svtcData, function (element) {    
		            			  return element.truck_type=='bulker';
		            			});*/
...
function factoryNames(names_list){
	...
	//	<button id="daily_id" class="button"> Daily </button>
		button_names=button_names+"<button class='button' id='"+names_list[i].association_alias_name+"_id' value='"+names_list[i].pk_association_id+"' >"+names_list[i].association_name+"</button>";		
    }
