	$(document).ready(function (){ 
				$('#get').click(function () {
					...
					$.ajax({
						url: '/transport/seller/dispatch/get/date',
						type: 'POST',
			            ...
			            success: function(response) {
			            	...
			            	var table_rows = "";
			            	var dispatch = "";
			            	var sellerDispatchList = response;
			            	for(var i=0; i<sellerDispatchList.SellerDispatch.length; i++){
			            		dispatch = sellerDispatchList.SellerDispatch[i];		            		
