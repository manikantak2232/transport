			...
			if(inwardDetails!=null){
				for(var i=0; i<inwardDetails.length; i++){
					...
					if(action == 'loading' & cement == 'PPC')
					{
						...
						loadingPpc = +loadingPpc + +Qua;
						//	alert(loadingPpc);
					}
					if(action == 'loading' & cement == 'OPC')
					{

						loadingOpc = +loadingOpc + +Qua;
						//	alert(loadingOpc);
					}
					...
					if(action == 'crossing-Inward' & cement == 'PPC')
					{

						crossingInwardPpc = Qua;
						//alert(crossingInwardPpc);
					}

					if(action == 'direct-Inward' & cement == 'PPC')
					{

						directInwardPpc = Qua;
						//alert(directInwardPpc);
					}
					if(action == 'pre-booking' & cement == 'PPC')
					{
					...
					if(action == 'crossing-Outward' & cement == 'PPC')
					{

						crossingOutwardPpc = Qua;
						//alert(crossingPpc);
					}
					if(action == 'direct-Outward' & cement == 'PPC')
					{

						directOutwardPpc = Qua;
						//alert(directOutwardPpc);
					}

					if(action == 'dc pending' & cement == 'PPC')
					{

						pendingPpc = Qua;
						//alert(pendingPpc);
					}
					if(action == 'advance booking' & cement == 'PPC')
					{
					...
					if(action == 'crossing-Inward' & cement == 'OPC')
					{

						crossingInwardOpc = Qua;
						//alert(crossingOpc);
					}


					if(action == 'direct-Inward' & cement == 'OPC')
					{
					...
					if(action == 'pre-booking' & cement == 'OPC')
					{
					...
					if(action == 'crossing-Outward' & cement == 'OPC')
					{

						crossingOutwardOpc = Qua;
						//alert(crossingOpc);
					}


					if(action == 'direct-Outward' & cement == 'OPC')
					{

						directOutwardOpc =Qua;
						//alert(directOpc);
					}
					if(action == 'dc pending' & cement == 'OPC')
					{

						pendingOpc =Qua;
						//alert(directOpc);
					}
					if(action == 'advance booking' & cement == 'OPC')
					{
					...
					if(action == 'unloading' & cement == 'OPC 53 PPW (TRADE)')
					{

						totalUnloadingInwardOpcTrade =Qua;
						//	alert(unloadingOpc);
					}
					
					if(action == 'crossing-Inward' & cement == 'OPC 53 PPW (TRADE)'){

						totalCrossingInwardOpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'direct-Inward' & cement == 'OPC 53 PPW (TRADE)'){

						totalDirectInwardOpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'pre-booking' & cement == 'OPC 53 PPW (TRADE)'){
					...
					if(action == 'crossing-Outward' & cement == 'OPC 53 PPW (TRADE)'){

						totalCrossingOutwardOpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}

					if(action == 'direct-Outward' & cement == 'OPC 53 PPW (TRADE)'){

						totalDirectOutwardOpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'dc pending' & cement == 'OPC 53 PPW (TRADE)'){

						pendingOpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'advance booking' & cement == 'OPC 53 PPW (TRADE)'){
					...
					if(action == 'crossing-Inward' & cement == 'PPC  PPW (TRADE)'){

						totalCrossingInwardPpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'direct-Inward' & cement == 'PPC  PPW (TRADE)'){

						totalDirectInwardPpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'pre-booking' & cement == 'PPC  PPW (TRADE)'){
					...
					if(action == 'crossing-Outward' & cement == 'PPC  PPW (TRADE)'){

						totalCrossingOutwardPpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'direct-Outward' & cement == 'PPC  PPW (TRADE)'){

						totalDirectOutwardPpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'dc pending' & cement == 'PPC  PPW (TRADE)'){

						pendingPpcTrade =  Qua;
						//	alert(totalOpcTrade);
					}
					if(action == 'advance booking' & cement == 'PPC  PPW (TRADE)'){
					...
					if(action == 'crossing-Inward' & cement == 'PSC'){

						totalCrossingInwardPsc =   Qua;

					}


					if(action == 'direct-Inward' & cement == 'PSC'){

						totalDirectInwardPsc =   Qua;

					}
					if(action == 'pre-booking' & cement == 'PSC'){
					...
					if(action == 'crossing-Outward' & cement == 'PSC'){

						totalCrossingOutwardPsc =   Qua;

					}


					if(action == 'direct-Outward' & cement == 'PSC'){

						totalDirectOutwardPsc =   Qua;

					}

					if(action == 'dc pending' & cement == 'PSC'){

						pendingPsc =   Qua;

					}

					if(action == 'advance booking' & cement == 'PSC'){
...
//========================================================== CON =============================================================					
					...
					if(action == 'crossing-Inward' & cement == 'CON'){

						totalCrossingInwardCon =   Qua;

					}


					if(action == 'direct-Inward' & cement == 'CON'){

						totalDirectInwardCon =   Qua;

					}

					if(action == 'pre-booking' & cement == 'CON'){
					...
					if(action == 'crossing-Outward' & cement == 'CON'){

						totalCrossingOutwardCon =   Qua;

					}


					if(action == 'direct-Outward' & cement == 'CON'){

						totalDirectOutwardCon =   Qua;

					}
					if(action == 'dc pending' & cement == 'CON'){
...
//==================================================Crossing Quantity=============================================================
					...
					if(cross > 0 & cement == 'PPC' ){
						totalCrossPpc = +totalCrossPpc + +cross;
						//alert(totalCrossPpc);
					}
					if(cross > 0 & cement == 'OPC' ){
						totalCrossOpc = +totalCrossOpc + +cross;
						//	alert(totalCrossOpc);
					}
					if(cross > 0 & cement == 'PSC' ){
						totalCrossPsc = +totalCrossPsc + +cross;
						//	alert(totalCrossPsc);
					}
					if(cross > 0 & cement == 'CON' ){
						totalCrossCon = +totalCrossCon + +cross;
						//	alert(totalCrossCon);
					}
					if(cross > 0 & cement == 'PPC  PPW (TRADE)' ){
						totalCrossPpcTrade = +totalCrossPpcTrade + +cross;
						//	alert(totalCrossPpcTrade);
					}
					if(cross > 0 & cement == 'OPC 53 PPW (TRADE)' ){
						totalCrossOpcTrade = +totalCrossOpcTrade + +cross;
						//	alert(totalCrossOpcTrade);
					}
...
//=================================================Direct Quantity============================================================	
					...
					if(directQuantity > 0 & cement == 'PPC' ){
						totalDirectPpc = +totalDirectPpc + +directQuantity;
						//alert(totalCrossPpc);
					}
					if(directQuantity > 0 & cement == 'OPC' ){
						totalDirectOpc = +totalDirectOpc + +directQuantity;
						//	alert(totalCrossOpc);
					}
					if(directQuantity > 0 & cement == 'PSC' ){
						totalDirectPsc = +totalDirectPsc + +directQuantity;
						//	alert(totalCrossPsc);
					}
					if(directQuantity > 0 & cement == 'CON' ){
						totalDirectCon = +totalDirectCon + +directQuantity;
						//	alert(totalCrossCon);
					}
					if(directQuantity > 0 & cement == 'PPC  PPW (TRADE)' ){
						totalDirectPpcTrade = +totalDirectPpcTrade + +directQuantity;
						//	alert(totalCrossPpcTrade);
					}
					if(directQuantity > 0 & cement == 'OPC 53 PPW (TRADE)' ){
						totalDirectOpcTrade = +totalDirectOpcTrade + +directQuantity;
						//	alert(totalCrossOpcTrade);
					}
				...
				if(company == 'zuari'){
					...
					var tUnloadingAmount = ((+unloadingPpc + +unloadingOpc + +directOpc + +directPpc + +crossingOpc + +crossingPpc)*hamali).toFixed(2);
				...
				//	document.getElementById("invoiceZuari").value = invoiceNumber;
					 */					
					var tUnloading = (+unloadingPpc + +unloadingOpc + +directInwardOpc + +directInwardPpc + +crossingInwardOpc + +crossingInwardPpc + +preOpc + +prePpc + +totalCrossPpc + +totalCrossOpc + +totalDirectPpc + +totalDirectOpc + +totalUnloadingInwardOpcTrade + +totalDirectInwardOpcTrade + +totalCrossingInwardOpcTrade + +preOpcTrade + +totalDirectOpcTrade + +totalCrossOpcTrade);
					 var tUnloadingAmount = ((+tUnloading)*hamali).toFixed(2);
					 var tLoading = (+loadingPpc + +loadingOpc + +directOutwardOpc + +directOutwardPpc + +crossingOutwardOpc + +crossingOutwardPpc + +pendingOpc + +pendingPpc + +advanceOpc + +advancePpc + +totalLoadingOpcTrade + + +totalCrossingOutwardOpcTrade +totalDirectOutwardOpcTrade + +pendingOpcTrade + +advanceOpcTrade);
					 var tLoadingAmount = ((+tLoading)*hamali).toFixed(2);
					 var tServiceAmount = ((+tUnloading)*serviceCharge).toFixed(2);
					 ...
					 loading_rows = 
						 ...
						 "<td colspan='2' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + tUnloading+ "</td>"+	
						 "<td colspan='1' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + hamali + "</td>"+
						 "<td colspan='1' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + tUnloadingAmount + "</td>"+
					 ...
					 Reloading_rows = 
						 ...
						 "<td colspan='2' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + tLoading + "</td>"+	
						 "<td colspan='1' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + hamali + "</td>"+
						 "<td colspan='1' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + tLoadingAmount + "</td>"+
					 ...
					 service_rows = 
						 ...
						 "<td colspan='1' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + tServiceAmount + "</td>"+
					 ...
					 total_rows = 
						 ...
						 "<td colspan='2' class='blank_row' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + (+tUnloadingAmount + +tLoadingAmount + +tServiceAmount ).toFixed(2) + "</td>"+	
					 ...
					 cgst_rows = 
						 ...
						 "<td colspan='2' class='blank_row' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + (( (+tUnloadingAmount + +tLoadingAmount + +tServiceAmount )*9)/(100)).toFixed(2)  + "</td>"+	
					 ...
					 Grand_rows = 
						 ...
						 "<td colspan='2' class='blank_row' style='border: 1px solid black;border-collapse:collapse;text-align:center;line-height: 100%;'>" + (+gtotal + +gcgst + +gsgst).toFixed(2) + "</td>"+	


						 "</tr>"
						 ;

					 grand_totalFinal = (+gtotal + +gcgst + +gsgst).toFixed(2);
				...
				if(company == 'ramco'){
					...
					/*var factory= "";
					var tables = "";  
					var totalCrossing =(+crossingOpc + +crossingPpc + totalCrossPpc + totalCrossOpc);
					...
					var factory= "";
					var tables = "";  
					var totalCrossing =(+crossingInwardOpc + +crossingInwardPpc + +totalCrossPpc + +totalCrossOpc);
					var totalUnloading = (+unloadingPpc +  +directInwardPpc + +unloadingOpc + +directInwardOpc + +prePpc + +preOpc + +totalDirectPpc + +totalDirectOpc);
					var totalLoading = (+loadingPpc + +loadingOpc + +directOutwardOpc + +directOutwardPpc + +pendingOpc + +pendingPpc + +advanceOpc + +advancePpc);
					var totalCrossingAmount = (+totalCrossing*hamali);
					var totalUnloadingAmount = (+totalUnloading*hamali);
					var totalLoadingAmount = (+totalLoading*hamali);
					var totalServiceChargeAmount = ((+totalCrossing + +totalUnloading)*serviceCharge);
					...
					var table_c  = 
						"<tr  width=100% >"+
						"<th width=10% style='border-collapse: collapse;border: 1px solid black;background-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + "S.NO"+ "</th>"+
						"<th width=10% style='border-collapse: collapse;border: 1px solid black;background-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + "PARTICULARS" + "</th>"+
						"<th width=10% style='border-collapse: collapse;border: 1px solid black;style='border: 1px solid black;background-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + "OPC" + "</th>"+
						"<th width=10% style='border-collapse: collapse;border: 1px solid black;background-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + "PPC" + "</th>"+ 
						"<th width=10% style='border-collapse: collapse;border: 1px solid black;background-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + "TOTAL QUANTITY"  + "</th>"+ 
						"<th width=10% style='border-collapse: collapse;border: 1px solid black;background-color:#CCCCCC; padding-left:3px; padding-right:3px'>"+ "RATE" + "</th>"+ 
						"<th width=10% style='border-collapse: collapse;border: 1px solid black;background-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + "AMOUNT" + "</th>"+ 
						"</tr>"+

						"<tr  width=100%>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center;padding-left:3px; padding-right:3px'>" + "1"+ "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:left; padding-left:3px; padding-right:3px'>" + "TRANSHIPMENT CHARGES" + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (crossingInwardOpc  +  +totalCrossOpc )  + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (crossingInwardPpc + +totalCrossPpc ) + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + totalCrossing  + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + hamali + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + totalCrossingAmount + "</td>"+ 
						"</tr>"+  
						"<tr  width=100% >"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center;padding-left:3px; padding-right:3px'>" + "2"+ "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:left; padding-left:3px; padding-right:3px'>" + "GODOWN UNLOADING CHARGES" + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (+unloadingOpc + +directInwardOpc + +preOpc + +totalDirectOpc) + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (+unloadingPpc + +directInwardPpc + +prePpc + +totalDirectPpc) + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + totalUnloading  + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + hamali + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + totalUnloadingAmount + "</td>"+ 
						"</tr>"+  

						"<tr  width=100% >"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center;padding-left:3px; padding-right:3px'>" + "3"+ "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:left; padding-left:3px; padding-right:3px'>" + "GODOWN LOADING CHARGES" + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (+loadingOpc + +directOutwardOpc + +pendingOpc + +advanceOpc) + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (+loadingPpc + +directOutwardPpc + +pendingPpc + +advancePpc) +"</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + totalLoading  + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + hamali + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + totalLoadingAmount + "</td>"+ 
						"</tr>"+ 

						"<tr  width=100% >"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center;padding-left:3px; padding-right:3px'>" + "4"+ "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:left; padding-left:3px; padding-right:3px'>" + "C&F SERVICE CHARGES" + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (+crossingInwardOpc + +unloadingOpc + +directInwardOpc  + totalCrossOpc +  +preOpc + +totalDirectOpc) + "</td>"+
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (+crossingInwardPpc + +unloadingPpc + +directInwardPpc + totalCrossPpc + +prePpc + +totalDirectPpc) + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + (+totalCrossing + +totalUnloading) + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + serviceCharge + "</td>"+ 
						"<td width=10% style='border-collapse: collapse;border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + totalServiceChargeAmount + "</td>"+ 
						"</tr>"+
						"<tr  width=100% >"+
						"<td width=10% style='border: 1px solid black;text-align:center;padding-left:3px; padding-right:3px'>" + "5"+ "</td>"+
						"<td width=10% style='border: 1px solid black;text-align:left; padding-left:3px; padding-right:3px'>" + "FIXED EXPENSES" + "</td>"+
						"<td width=10% style='border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+
						"<td width=10% style='border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + " "  + "</td>"+ 
						"<td width=10% style='border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid black;text-align:center; padding-left:3px; padding-right:3px'>" + fixedExpenses + "</td>"+ 
						"</tr>"+ 
						"<tr  width=100% >"+
						...
						"</tr>"+
						"<tr width=150% >"+
						"<td width=10% style='border: 1px solid blacktext-align:center;padding-left:3px; padding-right:3px'>" + " "+ "</td>"+
						"<td width=10% style='border: 1px solid blacktext-align:left; padding-left:3px; padding-right:3px'>" + "GST @18% on Total Charges" + "</td>"+
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " "  + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" +  " " + "</td>"+ 
						...
						"</tr>"+
						"<tr  width=150% >"+
						"<td width=5% style='border: 1px solid blacktext-align:center;padding-left:3px; padding-right:3px'>" + " "+ "</td>"+
						"<td width=10% style='border: 1px solid blacktext-align:left; padding-left:3px; padding-right:3px'>" + "CGST @ 9%" + "</td>"+
						"<td width=5% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+
						"<td width=5% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " "  + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + CGST + "</td>"+ 
						"</tr>"+
						"<tr width=150% >"+
						"<td width=5% style='border: 1px solid blacktext-align:center;padding-left:3px; padding-right:3px'>" + " "+ "</td>"+
						"<td width=10% style='border: 1px solid blacktext-align:left; padding-left:3px; padding-right:3px'>" + "SGST @ 9%" + "</td>"+
						"<td width=5% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+
						"<td width=5% style='border: 1px solid blacktext-align:center;padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " "  + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid blacktext-align:center; padding-left:3px; padding-right:3px'>" + SGST  + "</td>"+ 
						"</tr>"+
						"<tr width=150% >"+
						"<td width=10% style='border: 1px solid blackbackground-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + " "+ "</td>"+
						"<th width=10% style='border: 1px solid blackbackground-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + "GRAND TOTAL" + "</th>"+
						"<td width=10% style='border: 1px solid blackbackground-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + " " + "</td>"+
						"<td width=10% style='border: 1px solid blackbackground-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<td width=10% style='border: 1px solid blackbackground-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + " "  + "</td>"+ 
						"<td width=10% style='border: 1px solid blackbackground-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + " " + "</td>"+ 
						"<th width=10% style='border: 1px solid blackbackground-color:#CCCCCC; padding-left:3px; padding-right:3px'>" + grandTotal + "</th>"+ 
						"</tr>"; 
					grand_totalFinal = grandTotal;
					//	alert(grand_totalFinal);
					tabledata = "<table width=95% align=center  >" + table_c +"</table>";
				...
				if(company == 'deccan'){
					...
					var tquantity = (+crossingOutwardOpc + +crossingOutwardPpc + +loadingPpc + +loadingOpc + +directOutwardPpc + +directOutwardOpc + +pendingOpc + +pendingPpc  + +advanceOpc + +advancePpc + +totalLoadingOpcTrade + + +totalCrossingOutwardOpcTrade +totalDirectOutwardOpcTrade + +pendingOpcTrade + +advanceOpcTrade);
					var totalService = (+tquantity * serviceCharge);
					var CGST = ((+totalService*9)/100).toFixed(2) ;
					var SGST = ((+totalService*9)/100).toFixed(2) ;
					var grandTotalService = (+totalService + +CGST + +SGST).toFixed(2);
...
*/
					...
					var tPpcTrade = (+totalLoadingPpcTrade + +totalCrossingOutwardPpcTrade + +totalDirectOutwardPpcTrade + +pendingPpcTrade + +advancePpcTrade );
					var tOpcTrade = (+totalLoadingOpcTrade + +totalCrossingOutwardOpcTrade + +totalDirectOutwardOpcTrade + +pendingOpcTrade + +advanceOpcTrade);
					var tAmountPpc = (+tPpc * hamali5);
					var tAmountOpc = (+tOpc * hamali5);
					var tAmountPpcTrade =(+tPpcTrade * hamaliTrade);
					var tAmountOpcTrade =(+tOpcTrade * hamaliTrade);
				...
				if(company == 'chettinad'){
					...
					"<td colspan='1' width='12.5%' style='text-align:center; padding-left:3px; padding-right:3px'>" + " "  + "</td>"+ 
					"<td colspan='1' width='12.5%' style='text-align:center; padding-left:3px; padding-right:3px'>" + invoiceNumber  + "</td>"+ 
					"</tr>"+ 
