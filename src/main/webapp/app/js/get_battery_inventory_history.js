function inventoryHistory() {
	...
	requestData.upper_date= $('#upper_date').val();	
					...
					$.ajax({
						url: '/transport/spareparts/battery/inventory/history/get',
						type: 'POST',
			            ...
			            success: function(response) {
			            	...
			            	for(var i=0; i<inventoryHistoryList.inventoryHistory.length; i++){
				            	...
				            	table_rows = table_rows + 
				            					"<tr width=100%>"+
					            					...
					            					"<td width=15% style='text-align:left; padding-left:3px; padding-right:3px'>" + part.invoice_number + "</td>"+
					            					"<td width=15% style='text-align:left; padding-left:3px; padding-right:3px'>" + part.invoice_date + "</td>"+
			            	...
			            	var table_header = "<tr width=100%>"+
								            	...
								            	"<td width=15% style='background-color:#CCCCCC; padding-left:3px; padding-right:3px'>" +"Invoice Date" + "</td>"+
