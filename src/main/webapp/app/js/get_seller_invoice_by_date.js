	$(document).ready(function (){ 
				$('#get').click(function () {
					...
					$.ajax({
						url: '/transport/seller/invoice/get/date',
						type: 'POST',
			            ...
			            success: function(response) {
			            	...
			            	var table_rows = "";
			            	var invoice = "";
			            	var sellerInvoiceList = response;
			            	for(var i=0; i<sellerInvoiceList.SellerInvoice.length; i++){
			            		invoice = sellerInvoiceList.SellerInvoice[i];		            		
