$(document).ready(function (){ 
			...
			//		requestData.date= $('#date').val();				
					$.ajax({
						url: '/transport/factory/expenditure/get',
						type: 'POST',
			            	...
			            	for(var i=0; i<factoriesList.Factories.length; i++){
				            	...
				            	table_rows = table_rows + 
				            					"<tr width=100%>"+
					            					...
					            					"<td width=15% style='text-align:left; padding-left:3px; padding-right:3px; display:none'>" + factory.pk_factory_dispatch_id + "</td>"+		            						
				            						...
				            						"<td width=5% style='text-align:center; padding-left:3px; padding-right:3px'> <input type='button' id='but' onclick='fun("+factory.pk_factory_dispatch_id+")' value='get'></td>"+
				            					"</tr>";
...
function fun(factory_dispatch_id){
	...
	window.open("/app/views/close_factory_driver_expenditure.html?"+
		"factory_dispatch_id="+factory_dispatch_id+"&fk_driver_id="+fk_driver_id);
