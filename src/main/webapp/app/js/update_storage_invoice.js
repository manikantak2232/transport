 $(function() {
	    $('#get').click(function() {
	        ...
	        $.ajax({
	            type: 'GET',
	            url: '/transport/storage/invoice/get?'+'invoice_number='+invoice_number,
	            dataType: 'json',
	            contentType: 'application/json; charset=utf-8',
	            success: function(response) {
	            	
	            	var storageInvoice = response.StorageInvoice;	            	
	            	$.each(storageInvoice, function(key, value){
	            		$('#'+key+'').val(value);	            	   
	            	});         	
	            },
	  ...
	  $(document).ready(function (){ 
			$('#update').click(function () {
				...
				requestData.storage_invoice_id= $('#storage_invoice_id').val();
				...
				$.ajax({
					url: '/transport/storage/invoice/update',
					type: 'POST',
					dataType: 'json',
