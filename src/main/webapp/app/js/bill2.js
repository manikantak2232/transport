            ...
            xhr.abort();    
					...
					$.ajax({
			            ...
			            success: function(response) {
			            	...
			            	for(var i=0; i<svtcData.length; i++){
				            	...
				            	table_rows = table_rows + 
				            					...
				            					"<tr class='table'>"+
					            					"<td colspan='1' '>" + (i+1) + "</td>"+
					            					"<td colspan='1' '>" + 'Cement' + "</td>"+		            						
				            						"<td colspan='1' '>" + factory.unload_location + "</td>"+	
				            						"<td colspan='1' '>" + factory.load_quantity + "</td>"+
				            						"<td colspan='1' '>" + factory.freight + "</td>"+
				            						"<td colspan='1'>"+ ''+"</td>"+
				            						"<td colspan='1' >"+ ''+"</td>"+
				            						"<td colspan='1' >"+ ''+"</td>"+
				            						"<td colspan='1' >"+ ''+"</td>"+
		            	...
		            	table_rows=table_rows+
        						...
        						"<td colspan='1' width=10% style='border:none;'>" + '' + "</td>"+	
        						"<td colspan='1' width=7% style='border:none;'>" + '' + "</td>"+
        						"<td colspan='1' width=7% style='border:none;'>" + '' + "</td>"+
        						"<td colspan='1'width=7% style='text-align:left; padding-left:3px; padding-right:3px'>" + totalQuantity + "</td>"+
        						"<td colspan='1' width=7% style='text-align:left; padding-left:3px; padding-right:3px'>" + totalFreight + "</td>"+
        						"<td colspan='1' >"+ ''+"</td>"+
        						"<td colspan='1' >"+ ''+"</td>"+
        						"<td colspan='1' >"+ ''+"</td>"+
        						"<td colspan='1' >"+ ''+"</td>"+
			            	...
			            	var table_header = 
				            	...
				            	"<td colspan='1'><h5'>" +"S.No" + "</h5></td>"+
				            	"<td colspan='1'><h5>" +"DESCRIPTION OF BILL" + "</h5></td>"+
								"<td colspan='1'><h5>" + "DESTINATION" + "</h5></td>"+
								"<td colspan='1'><h5>" + "QTY IN (MT)" + "</h5></td>"+
								"<td colspan='1'><h5>"  + "FREIGHT" + "</h5></td>"+
								"<td colspan='1'><h5>" + "TOTAL" + "</h5></td>"+
								"<td colspan='1'><h5>" + "SHORTAGES" + "</h5></td>"+
