...
public class SellerDAO {
	...
	final static Logger log = Logger.getLogger(SellerDAO.class);
	...
	public static HashMap<String, Object> addSellerFuel(
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.ADD_SELLER_FUEL));
	...
	public static HashMap<String, Object> addSellerDispatch(
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.ADD_SELLER_DISPATCH));
	...
	public static HashMap<String, Object> addSellerInvoice(
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.ADD_SELLER_INVOICE));
	...
	public static HashMap<String, Object> addSellerPurchase(
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.ADD_SELLER_PURCHASE));
	...
	public static HashMap<String, Object> getSellerDispatch(String invoice_number) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_DISPATCH));
	...
	//		ArrayList<HashMap<String, Object>> sellerDispatch = new ArrayList<HashMap<String, Object>>();
			...
			while(rset.next()){
				...
				dispatch.put("seller_dispatch_id", rset.getInt("pk_seller_dispatch_id"));
			...
			//	sellerDispatch.add(dispatch);
				responseParameters.put("SellerDispatch", dispatch);
			}
	...
	public static HashMap<String, Object> getSellerFuel(int fk_truck_id) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_FUEL));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
		...
		//	ArrayList<HashMap<String, Object>> sellerFuel = new ArrayList<HashMap<String, Object>>();
			
			while(rset.next()){
				HashMap<String, Object> fuel = new HashMap<String, Object>();
				fuel.put("seller_fuel_id", rset.getInt("pk_seller_fuel_id"));
		...
		//		sellerFuel.add(fuel);
				responseParameters.put("SellerFuel", fuel);
			}
	...
	public static HashMap<String, Object> getSellerInvoice(String invoice_number) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_INVOICE));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
	...
	//		ArrayList<HashMap<String, Object>> sellerInvoice = new ArrayList<HashMap<String, Object>>();
			...
			while(rset.next()){
				...
				invoice.put("seller_invoice_id", rset.getInt("pk_seller_invoice_id"));
			...
			//	sellerInvoice.add(invoice);
				responseParameters.put("SellerInvoice", invoice);
			}
	...
	public static HashMap<String, Object> getSellerPurchase(String invoice_number) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_PURCHASE));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
		...
		//	ArrayList<HashMap<String, Object>> sellerPurchase = new ArrayList<HashMap<String, Object>>();
			
			while(rset.next()){
				HashMap<String, Object> purchase = new HashMap<String, Object>();
				purchase.put("seller_purchase_id", rset.getInt("pk_seller_purchase_id"));
				purchase.put("invoice_no", rset.getString("invoice_number"));
				purchase.put("name_of_brand", rset.getString("name_of_brand"));
				purchase.put("number_of_bags", rset.getInt("number_of_bags"));
				purchase.put("cost_per_bag", rset.getDouble("cost_per_bag"));				
				purchase.put("total_value", rset.getDouble("total_value"));
				purchase.put("date", rset.getString("date"));
			
				
	//			sellerPurchase.add(purchase);
				responseParameters.put("SellerPurchase", purchase);
			}
	...
	public static HashMap<String, Object> getSellerDispatchByDate(String lower_date, String upper_date) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_DISPATCH_BY_DATE));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
...
ArrayList<HashMap<String, Object>> sellerDispatch = new ArrayList<HashMap<String, Object>>();
			...
			responseParameters.put("SellerDispatch", sellerDispatch);
	...
	public static HashMap<String, Object> getSellerFuelBydate(String lower_date, String upper_date , int fk_truck_id) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_FUEL_BY_DATE));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
			...
			responseParameters.put("SellerFuel", sellerFuel);
	...
	public static HashMap<String, Object> getSellerInvoiceByDate(String lower_date, String upper_date) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_INVOICE_BY_DATE));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
...
ArrayList<HashMap<String, Object>> sellerInvoice = new ArrayList<HashMap<String, Object>>();
			...
			responseParameters.put("SellerInvoice", sellerInvoice);
	...
	public static HashMap<String, Object> getSellerPurchaseByDate(String lower_date, String upper_date) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_PURCHASE_BY_DATE));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
...
ArrayList<HashMap<String, Object>> sellerPurchase = new ArrayList<HashMap<String, Object>>();
			...
			while(rset.next()){
				HashMap<String, Object> purchase = new HashMap<String, Object>();
				purchase.put("invoice_number", rset.getString("invoice_number"));
				purchase.put("name_of_brand", rset.getString("name_of_brand"));
				purchase.put("number_of_bags", rset.getInt("number_of_bags"));
				purchase.put("cost_per_bag", rset.getDouble("cost_per_bag"));				
				purchase.put("total_value", rset.getDouble("total_value"));
			...
			responseParameters.put("SellerPurchase", sellerPurchase);
	...
	public static HashMap<String, Object> updateSellerFuel(
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.UPDATE_SELLER_FUEL));

			callableStatement.setInt("seller_fuel_id", seller_fuel_id);
	//		callableStatement.setInt("fk_truck_id", fk_truck_id);
			callableStatement.setDouble("fuel_quantity", fuel_quantity);			
			callableStatement.setDouble("fuel_rate", fuel_rate);
			callableStatement.setDouble("amount", amount);
	...
	//		String dispatch_status
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.UPDATE_SELLER_DISPATCH));

			callableStatement.setInt("seller_dispatch_id", seller_dispatch_id);
			callableStatement.setInt("fk_truck_id", fk_truck_id);
			callableStatement.setInt("fk_driver_id", fk_driver_id);			
			callableStatement.setString("invoice_number", invoice_number);
			callableStatement.setString("start_location", start_location);
	...
	//		String invoice_number,
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.UPDATE_SELLER_INVOICE));

			callableStatement.setInt("seller_invoice_id", seller_invoice_id);
//			callableStatement.setString("invoice_number", invoice_number);
			callableStatement.setString("customer_first_name", customer_first_name);			
			callableStatement.setString("customer_middle_name", customer_middle_name);
			callableStatement.setString("customer_last_name", customer_last_name);
	...
	//		String invoice_number,
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.UPDATE_SELLER_PURCHASE));

			callableStatement.setInt("seller_purchase_id", seller_purchase_id);
//			callableStatement.setString("invoice_number", invoice_number);
			callableStatement.setString("name_of_brand", name_of_brand);			
			callableStatement.setInt("number_of_bags", number_of_bags);
			callableStatement.setDouble("cost_per_bag", cost_per_bag);
	...
	public static HashMap<String, Object> getStatusDispatch(int truck_id) throws TransportException, SQLException {
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_STATUS_DISPATCH));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
	...
	//		ArrayList<HashMap<String, Object>> sellerDispatch = new ArrayList<HashMap<String, Object>>();
			...
			while(rset.next()){
				...
				status.put("seller_dispatch_id", rset.getInt("pk_seller_dispatch_id"));
	...
	public static HashMap<String, Object> updateStatusDispatch(
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.UPDATE_STATUS_DISPATCH));
	...
	public static HashMap<String, Object> getCloseDispatch(int truck_id) throws TransportException, SQLException {
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_CLOSE_DISPATCH));
		//	HashMap<String, Object> cards = new HashMap<String, Object>();
	...
	public static HashMap<String, Object> updateCloseDispatch(
		...
		try {									
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.UPDATE_CLOSE_DISPATCH));
...
//			callableStatement.setString("dispatch_status", dispatch_status);
	...
	public static HashMap<String, Object> getDispatchedTrucks() throws TransportException, SQLException {
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_DISPATCHED_TRUCKS));
			callableStatement.setString("username", username);
			callableStatement.registerOutParameter("outResult", java.sql.Types.BOOLEAN);
			callableStatement.registerOutParameter("errCode", java.sql.Types.CHAR);
			callableStatement.registerOutParameter("message", java.sql.Types.VARCHAR);
	...
	public static HashMap<String, Object> getUnloadingTrucks() throws TransportException, SQLException {
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_UNLOADING_TRUCKS));
			callableStatement.setString("username", username);
			callableStatement.registerOutParameter("outResult", java.sql.Types.BOOLEAN);
			callableStatement.registerOutParameter("errCode", java.sql.Types.CHAR);
			callableStatement.registerOutParameter("message", java.sql.Types.VARCHAR);
	...
	public static HashMap<String, Object> getSellerChange(int truck_id) throws TransportException, SQLException {
		HashMap<String, Object> responseParameters = new HashMap<String, Object>();
		Connection connection = JDBCConnectionUtils.getJDBCConnection();
		String errorMessage = "";
		responseParameters.put("result", true);
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_CHANGE));
	...
	//		ArrayList<HashMap<String, Object>> trucksDetails = new ArrayList<HashMap<String, Object>>();
			...
			while (rset.next()) {
				...
				number.put("fk_seller_dispatch_id", rset.getInt("fk_seller_dispatch_id"));
	...
	public static HashMap<String, Object> addSellerDriverChange(int fk_seller_dispatch_id, int fk_driver_id,
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.ADD_SELLER_DRIVER_CHANGE));
			callableStatement.setInt("fk_seller_dispatch_id", fk_seller_dispatch_id);
	...
	public static HashMap<String, Object> getSellerDriverExpenditure(int fk_driver_id, String date)
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_DRIVER_EXPENDITURE));
			...
			while (rset.next()) {
				...
				factory.put("pk_seller_dispatch_id", rset.getInt("pk_seller_dispatch_id"));
	...
	public static HashMap<String, Object> getSellerDriversCloseExpenditure(int seller_dispatch_id)
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.GET_SELLER_DRIVERS_CLOSE_EXPENDITURE));
	...
	public static HashMap<String, Object> addSellerDriverExpenditure(int seller_dispatch_id,int fk_driver_id,
		...
		try {
			callableStatement = connection
					.prepareCall(StoredProcsMap.ProcIDsVsNames.get(StoredProcsMap.ADD_SELLER_DRIVER_EXPENDITURE));
			callableStatement.setInt("seller_dispatch_id", seller_dispatch_id);
			callableStatement.setInt("driver_id", fk_driver_id);
			callableStatement.setString("username", username);
			callableStatement.setInt("transport", transport);
